...
variable "worker_subnets" {
  description = "A list of worker subnets inside the VPC"
  default     = []
}

# NACL
variable "worker_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for worker subnets"
  default     = false
}

variable "worker_inbound_acl_rules" {
  description = "worker subnets inbound network ACLs"
...
variable "worker_outbound_acl_rules" {
  description = "worker subnets outbound network ACLs"
