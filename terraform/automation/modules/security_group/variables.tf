...
variable "ec_ingress_rules" {
  description = "Ingress rules for ElastiCache resources"
  default = []
}

variable "ec_egress_rules" {
  description = "Egress rules for ElastiCache resources"
  default = [
    {
      cidr_blocks = "0.0.0.0/0"
      from_port = 0
...
variable "worker_ingress_rules" {
  description = "Ingress rules for Cron/Worker resources"
  default = []
}

variable "worker_egress_rules" {
  description = "Egress rules for Cron/Worker resources"
  default = [
    {
      cidr_blocks = "0.0.0.0/0"
      from_port = 0
